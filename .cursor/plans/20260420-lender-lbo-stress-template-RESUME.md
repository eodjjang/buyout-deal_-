...
**없음.** HEAD `f969309` 기준 워크트리 클린·`pytest` 71 passed·태그 `v0.5.0`.
...
git log --oneline -5                             # f969309, b45e058, fc83825, …
git describe --tags --always                     # v0.5.0 또는 f969309
